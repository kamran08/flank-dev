                    ...
                    <div class="review-content">
                        <div class="breadcrumbs">
                            <ul>
                                ...
                                <li><span><i class="fas fa-chevron-right"></i></span><nuxt-link :to="{name: 'productQuestionlist-id', params: { id:legend_id } }">Ask the Community</nuxt-link></li>
...
export default {
    ...
    async asyncData({app, store,redirect, params}){
        try {
            let {data} = await app.$axios.get(`/app/product_question_answers/${params.id}`)
    ...
    methods:{
        async answerQuestion(){
            ...
            const res = await this.callApi('post','/app/storeProductanswers',this.answerData)
            if(res.status===200){
