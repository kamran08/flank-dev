                ...
                <div class="section-content">
                    <div class="review-content rem-review-content">
                        <div class="breadcrumbs">
                            <ul class="no-border">
                                <li><nuxt-link :to="{name: 'school-id', params: { id:legend_id } }">{{legendData.schoolName}}</nuxt-link></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                ...
                                <div class="view-sect" v-if="legendData.logo">
                                    <div class="view-media">
                                        ...
                                        <div class="media" style="display: flex; flex-flow: row;"  >
                                            <div class="media-left" style="flex: 0 0 110px; width: 110px;">
                                                <img style="width: 100%" class="profile_picU" :src="legendData.logo" alt="">
                                            </div>
                                            <div class="media-body new-med" style="flex: 75%; width: 100%;">
                                                <h4><nuxt-link :to="{name: 'school-id', params: { id:legend_id } }">{{legendData.schoolName}}</nuxt-link></h4>
                                                <h5 style="margin-bottom: 5px;">{{legendData.sport}}</h5>
                                                <div class="star-review">
                                                    ...
                                                    <h5>{{legendData.city}}/{{legendData.state}}</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
export default {
    ...
    methods:{
        ...
        setPage(index){
         ...
         async pageniateQuestion(index){
            ...
            const res = await this.callApi('get', `schoolquestions/${this.$route.params.id}?page=${this.rpagination.page}&?type=school`)
            if(res.status===200){
     ...
     async asyncData({app, store,redirect, params}){
        try {
            ...
            let {data} = await app.$axios.get(`app/schoolquestions/${params.id}?type=school`)
    ...
    async created(){
        ...
        if(res1.status===200){ 
                ...
                this.averageRating = this.legendData.avgRating.averageRating
        } else{
            this.swr()
        }
    }
