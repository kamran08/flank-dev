            ...
            <!-- <div class="signcont-left">
              <form v-on:submit.prevent>
                ...
                <div class="group-item">
                  <label>Password</label>
                  <nuxt-link
                    class="group-item-right red-alert group-item-forgot-pass"
                    to="/authentication/resetpassword"
                  >Fogot password?</nuxt-link>
                  <input type="password" v-model="formData.password" />
                </div>
              </form>
              <p
                class="mar_b20"
              >By continuing, you agree to Conditions Flank's of Use and Privacy Notice</p>
              <h5 class="mar_b30">
                <input type="checkbox" name="vehicle1" value="Bike" /> Keep me sign in.
                <a href="#" class="sign-in">Details</a>
              </h5>
